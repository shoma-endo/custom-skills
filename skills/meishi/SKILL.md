...
- 渡す→「裏のQRから特典受け取ってください、30秒です」→**その場でLINE登録**。リスト取りが本命、名刺は敗者復活戦
- 会食・交流会後は**24時間以内**に「昨日の件、こう作れます」の図解1枚をLINEで送る。差別化は会場でなくフォロー速度で決まる
- 会話メモは事実と解釈を分けて記録（フォロー文面の材料）
- 場選びは「同業がいないか」でなく「決裁者がいるか」。①決裁者が来る ②業務の痛みと財布がある ③継続接点が生まれる、の3条件で選ぶ
